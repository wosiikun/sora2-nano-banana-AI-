...
class VideoYuanaiGenerator:
    ...
    def __init__(self):
        ...
        API密钥已写死在代码中
        """
        self.api_key = ""  # 在这里填写你的API密钥
        self.api_host = ""  # 根据实际API地址修改
    ...
    def poll_result(self, task_id):
        ...
        while True:
            ...
            response = requests.get(
                f"{self.api_host}/v1/video/task/{task_id}",
                headers=headers,
                timeout=10
            )
    ...
    def generate(self, image_url, prompt, duration=15, save_path=None):
        """
        生成视频(图生视频)
        ...
        endpoint = f"{self.api_host}/v1/video/generate"
